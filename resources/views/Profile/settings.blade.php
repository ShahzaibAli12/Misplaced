...
$Cityarray = [
    ...
    233 => 'Zhob',
    234 => 'Ziarat',
]; ?> @extends('Layout.layout') @section('title','Profile Settings') @section('style') @endsection @section('content') <section class="checkout-wrapper section col-12 pt-4 pb-4 ">
  <div class="container">
            ...
            <div class="mt-5">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="profile" role="tabpanel">
                  <form method="POST" action="{{ route('profile_settings.update') }}" enctype="multipart/form-data"> @csrf <div class="rounded-3 p-4 mb-4">
                ...
                <div class="tab-pane fade mt-4" id="password" role="tabpanel">
                    <form method="POST" action="{{ route('profile_settings.password.update') }}">
                        @csrf
...
</section> @endsection @section('script') <script>
