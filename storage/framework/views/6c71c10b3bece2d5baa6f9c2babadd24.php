            ...
            <div class="row">
              <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10">
                <div class="hero__caption text-center" >
                  ...
                  <a href="/signup" class=" mx-auto btn btn-primary"
                  >Join Now <iconify-icon icon="material-symbols:login"></iconify-icon></a>
            </div>
              ...
              <div class="col-lg-5">
                ...
                >
                  <img class="w-75 ms-auto" src=<?php echo e(asset('img/hero/hero-man.png')); ?> alt />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="services-active dot-style">
              <div class="single-services mb-30 text-center">
                ...
                <div class="services-cap">
                  ...
                  <h4 class="text-center border-top pt-4">Ahmed</h4>
                </div>
              </div>
              ...
              <div class="single-services mb-30 text-center">
                ...
                <div class="services-cap">
                  ...
                  <h4 class="text-center border-top pt-4">Ali Akbar</h4>
              ...
              <div class="single-services mb-30 text-center">
                ...
                <div class="services-cap">
                  ...
                  <h4 class="text-center border-top pt-4">M.Ali</h4>
        ...
        <div class="wants-wrapper w-padding">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
              <button href="/" style="border:1px solid white" class="text-white btn   f-right"
...
<?php echo $__env->make('Layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\xampp\htdocs\Misplaced\resources\views/welcome.blade.php ENDPATH**/ ?>